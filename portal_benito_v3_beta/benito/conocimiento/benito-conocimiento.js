window.BENITO_CONOCIMIENTO = [
    ...
    ,{
      id: 'aec-2026', priority: 20,
      phrases: ['acuerdo escolar de convivencia','que es el aec','descargar aec','normas de convivencia','consejo escolar de convivencia'],
      keywords: ['aec','convivencia','acuerdo','normas','sanciones','celular','uniforme','consejo'],
      title: 'Acuerdo Escolar de Convivencia 2026',
      html: 'El <strong>Acuerdo Escolar de Convivencia 2026</strong> orienta la vida institucional y establece principios, derechos, responsabilidades, pautas de convivencia y procedimientos de intervención. Promueve el diálogo, la participación, la proporcionalidad y las acciones reparatorias con sentido pedagógico.',
      actions: [['Leer el AEC','../assets/documentos/acuerdo-escolar-convivencia-2026.pdf'],['Ir a Biblioteca','../biblioteca.html'],['Ver Vida Escolar','../vida-escolar.html#convivencia']]
    },
    {
      id: 'proyecto-nos-cuidamos', priority: 18,
      phrases: ['nos cuidamos en comunidad','proyecto de habitos saludables','proyecto reconocido provincial'],
      keywords: ['cuidamos','comunidad','habitos','saludables','salud','proyecto','reconocimiento','provincial'],
      title: 'Nos cuidamos en comunidad',
      html: 'Es un proyecto interdisciplinario de promoción de hábitos saludables que integra investigación, producción de materiales y acciones comunitarias. Fue seleccionado entre los proyectos destacados de la 6.ª edición del certamen provincial “Me Activo, Me Cuido, Nos Cuidamos 2026”. La participación docente permanece abierta a nuevas incorporaciones.',
      actions: [['Conocer el proyecto','../proyectos.html'],['Ver reconocimiento','../proyectos.html#reconocimiento']]
    },
    {
      id: 'biblioteca-institucional', priority: 15,
      phrases: ['biblioteca institucional','documentos de la escuela','donde estan los documentos'],
      keywords: ['biblioteca','documentos','pdf','descargar','normativa','proyectos'],
      title: 'Biblioteca Institucional',
      html: 'La Biblioteca Institucional reúne documentos públicos organizados por categorías. Ya podés consultar el AEC 2026 y la ficha del proyecto “Nos cuidamos en comunidad”.',
      actions: [['Abrir Biblioteca','../biblioteca.html']]
    },
    {
      id: 'servicios-portal', priority: 14,
      phrases: ['servicios de la escuela','centro de ayuda','que tramite puedo hacer'],
      keywords: ['servicios','ayuda','tramite','accesos','buscar'],
      title: 'Portal de Servicios',
      html: 'El Portal de Servicios reúne accesos rápidos para estudiantes, familias, docentes y comunidad: SAGE, constancias, Aula Digital, Biblioteca, comunicaciones y contacto con Secretaría.',
      actions: [['Abrir Servicios','../servicios.html']]
    }
];
